...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'db_xyw/templates').replace('\\', '/'),
...
USE_TZ = True
LOGIN_URL='/db_xyw/login/'
LANGUAGE_CODE = 'zh-Hans'
# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/3.0/howto/static-files/

STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'db_xyw/templates/db_xyw/static/').replace('\\', '/')
